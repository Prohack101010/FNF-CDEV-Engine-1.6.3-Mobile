...
class StorageUtil
{
	...
	public static var packageName:String = 'com.core5570r.cdevengine';
	...
	public static function getExternalStorageDirectory():String
	{
		...
		if (!FileSystem.exists(rootDir + 'storagetype.txt'))
			File.saveContent(rootDir + 'storagetype.txt', CDevConfig.saveData.storageType);
		...
		switch(curStorageType) {
			case 'EXTERNAL':
				daPath = '/storage/emulated/0/.CDEV Engine';
			case 'EXTERNAL_OBB':
			...
			default:
				daPath = getExternalDirectory(curStorageType) + '.CDEV Engine';
		}
	...
	public static function requestPermissions():Void
	{
		...
		try
		{
			if (!FileSystem.exists(StorageUtil.getStorageDirectory() + 'cdev-mods/'))
				FileSystem.createDirectory(StorageUtil.getStorageDirectory() + 'cdev-mods/');
		}
		catch (e:Dynamic)
		{
			CoolUtil.showPopUp('Please create directory to\n${StorageUtil.getStorageDirectory() + 'cdev-mods/'}\nPress OK to close the game', "Error!");
			lime.system.System.exit(1);
		}
		*/
	}
